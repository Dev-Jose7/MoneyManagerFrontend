...
export default class User {
    ...
    constructor(name, email, password) {
        ...
        User.saveDataSession(); // Guarda los datos en localStorage.
    }
    ...
    static saveDataSession() {
        localStorage.setItem("database", JSON.stringify(User._userData));
    }
...
// - Garantiza la persistencia de los datos a través de localStorage.
...
// 3. Persistencia: Usa localStorage para conservar datos entre sesiones.
...
// 3. Persistencia de Datos: Los cambios se guardan automáticamente en localStorage.  
...
- **Persistencia:** Usa localStorage para conservar los datos entre sesiones.  
- **Métodos Principales:**  
   ...
   - `saveDataSession`: Guarda datos en localStorage.  
   - `loadDataSession`: Restaura los datos desde localStorage.  
- **Flujo de Uso:**  
